/**
 * Contributor Budget Charts - Personal expense analytics for contributors
 */
...
interface ContributorBudgetChartsProps {
...
const ContributorBudgetCharts = ({
  expenses,
}: ContributorBudgetChartsProps) => {
  // Calculate totals
  ...
  // Ministry breakdown
  const ministryBreakdown = expenses.reduce((acc, expense) => {
    const ministryName = expense.ministry?.name || "Unknown";
    if (!acc[ministryName]) {
      acc[ministryName] = { count: 0, amount: 0 };
    }
    acc[ministryName].count += 1;
    acc[ministryName].amount += expense.amount;
    return acc;
  }, {} as Record<string, { count: number; amount: number }>);
  ...
  return (
    <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                ...
                My Expenses by Status
              </CardTitle>
              <CardDescription>
                Distribution of your expense requests
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        {monthlyData.length > 0 && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>Your expense requests over time</CardDescription>
            </CardHeader>
            <CardContent>
              <ResponsiveContainer width="100%" height={300}>
        ...
        {ministryData.length > 0 && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Your expenses across different ministries
              </CardDescription>
            </CardHeader>
            <CardContent>
              <ResponsiveContainer width="100%" height={300}>
      ...
      <Card>
        <CardHeader>
          <CardTitle>My Expense Summary</CardTitle>
          <CardDescription>
            Detailed breakdown of all your expense requests
          </CardDescription>
        </CardHeader>
        <CardContent>
              ...
              <tbody>
                {Object.entries(statusBreakdown)
                  ...
                  .map(([status, data]) => {
                    ...
                    return (
                      <tr key={status} className="border-b hover:bg-muted/50">
...
export default ContributorBudgetCharts;
